 ...
 * </ul>
 */
public final class StopFilterWKO extends FilteringTokenFilter {

  private final CharArraySet stopWords;
  private final CharTermAttribute termAtt = addAttribute(CharTermAttribute.class);
  private static final Logger LOGGER = Logger.getLogger(StopFilterWKO.class);
  /**
   ...
   */
  public StopFilterWKO(Version matchVersion, TokenStream in, CharArraySet stopWords) {
  ...
  protected boolean accept() {
	  String s = new String(termAtt.buffer());
	  LOGGER.error("ABCDEF "+(s.substring(0,  termAtt.length())));
